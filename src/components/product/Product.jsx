    ...
    <section className="py-8 overflow-x-hidden">
      <div className="container max-w-[1240px] mx-auto px-5">
        <p className="pb-8 text-xl dark:text-white">
          ...
           vazirlar mahkamasining 2024-yil 19 oktyabrdagi 690-sonli
          “Yoqilg‘i-Energetika resurslari isteʼmolchilarini hamda bino va
          inshooatlarni energiya isteʼmolini energiya auditdan o‘tkazish
          tartiiblarini belgtlash tog‘risidagi”   qaroriga asosan o‘tkaziladi.
          <br /> Mazkur, 940-sonli qonuning 3-moddasiga ko’ra yiliga besh yuz
          hamda undan ortiq tonna shartliyoqilg‘ini va (yoki) ikki yuz ellik va
          ...
          hisoblanadi. Shu qonuning 16-moddasiga ko’ra Energiyaauditi majburiy
          va ixtiyoriy tarzda tashkil etililib, Davlat energetika reyestriga
          kiritilgan subyektlarda Majburiy energiya auditi o’tkaziliadi.  
          <br /> Yoqilg‘i-energetika resurslari iste’molchilarining energiya
          auditi O‘zbekiston Respublikasi Vazirlar Mahkamasi tomonidan
          belgilangan tartibda o‘tkaziladi. Energetiktekshiruv (energoaudit)
          bajariladigan korxonalar ro’yxati
          <br /> Isteʼmolchilarga o‘zlarining tasarrufidagi mavjud maʼnan
          eskirgan va foydali ish koeffitsiyenti past bo‘lgan gazdan foydalanish
          uskunasini yangi energiya tejamkor uskunalarga almashtirish natijasida
          iqtisod qilingan tabiiy gaz hajmiga 3 yil davomida amaldagi tarifga
          nisbatan 15 foiz chegirma beriladi. Bunda: <br /> -isteʼmolchilar
          gazdan foydalanish uskunasini almashtirish jadvali va uning natijasida
          ...
          etadi; tasdiqlangan dasturga asosan amalga oshirilgan ishlar
          ...
          <br /> -Energiya auditor xulosasi O‘zenergoinspeksiya va gaz taʼminoti
          ...
          quyidagi soliqlarni to‘lashdan ozod etiladi: ushbu qurilmalar bo‘yicha
          — yuridik shaxslarning mol-mulkiga solinadigan soliqni, alohida
          turuvchi qurilmalar bilan band bo‘lgan yer uchastkalari bo‘yicha —
          yuridik shaxslardan olinadigan yer solig‘ini, elektr energiyasini
          umumiy tarmoqqa sotishdan olingan foyda bo‘yicha <br /> — foyda
          solig‘ini; uy-joy fondining ko‘chmas mulk obyektlari bo‘yicha jismoniy
          shaxslardan olinadigan mol-mulk solig‘i va jismoniy shaxslardan
          olinadigan yer solig‘ini. <br /> Agar qurilmalar o‘rnatilayotgan
          quyosh panellari quvvatining 25 foizidan kam bo‘lmagan quvvatni
          tashkil etadigan elektr energiyasini saqlash tizimi bilan o‘rnatilgan
          bo‘lsa, ushbu kichik bandda nazarda tutilgan soliq imtiyozlari ular
          foydalanishga topshirilgan kundan boshlab o‘n yil muddatga
          qo‘llaniladi. <br /> Ushbu kichik bandda belgilangan soliq imtiyozlari
          jismoniy shaxslarga ular tomonidan umumiy quvvati 1 kVtdan ortiq
          bo‘lgan qayta tiklanuvchi energiya manbalari qurilmalari o‘rnatilganda
          har bir obyekt bo‘yicha bir marotaba qo‘llaniladi. Bunda soliq
          imtiyozlarining yillik miqdori jismoniy shaxslardan olinadigan
          mol-mulk solig‘i bo‘yicha — bazaviy hisoblash miqdorining ikki
          baravaridan, jismoniy shaxslardan olinadigan yer solig‘i bo‘yicha esa
          — bazaviy hisoblash miqdoridan oshmasligi lozim
          <br />
