...
import { EffectCreative, Autoplay, EffectFade } from "swiper/modules";
import img1 from "@/images/men.jpg";
import { HiOutlineCheck } from "react-icons/hi";

const Worker = () => {
    return (
        <section className="py-9 bg-[#daecf5] dark:bg-transparent">
            <div className="container max-w-[1240px] mx-auto px-5">
                ...
                <div>
                    <h2 className="text-center text-xl lg:text-3xl font-medium mb-3 lg:mb-5 dark:text-white">
                        Direktor
                    </h2>
                    <div className="flex flex-col min-[800px]:flex-row items-start justify-between gap-x-4">
                        ...
                        <div>
                            ...
                            <p className="text-lg lg:text-xl flex items-center gap-x-3 mb-4 dark:text-white">
                                <HiOutlineCheck />
                                2000-yil 24-yosh
                            </p>
                            <div className="border p-1 rounded-md">
                                <p className="text-slate-600 text-sm lg:text-base dark:text-slate-300">
                ...
                <div className="grid grid-cols-1 min-[440px]:grid-cols-2 min-[860px]:grid-cols-3 gap-x-6 gap-y-6 mt-5">
                    <div className="hover:scale-105 transition-all">
                        ...
                        <p className="text-lg flex items-center gap-x-3 mb-3 dark:text-slate-300">
                            2000-yil 24-yosh
                        </p>
                        <div className="border p-1 rounded-md">
                            <p className="text-slate-600 text-sm lg:text-base dark:text-slate-300">
