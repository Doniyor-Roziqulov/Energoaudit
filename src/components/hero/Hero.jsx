                    ...
                    <div>
                        <div className="bg-cover h-[250px] min-[500px]:h-[300px] min-[720px]:h-[350px] min-[900px]:h-[400px] min-[1070px]:h-[450px] xl:h-[500px]  rounded-xl border-2 relative">
                            ...
                            <p className="text-sm relative text-white text-center mt-6 px-2 lg:text-lg">
                                ...
                                quia tempore nobis libero dolor dolorem, aperiam
                                quasi? Necessitatibus earum labore dolores
                                quaerat quos numquam amet, aliquam, quas nobis,
                                veniam quis cum? Incidunt
                            </p>
                        </div>
                    </div>
                    <div>
